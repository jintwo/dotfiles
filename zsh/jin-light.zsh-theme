...
ZSH_THEME_GIT_PROMPT_PREFIX="%F{$gray9}[git:"
# ZSH_THEME_GIT_PROMPT_SUFFIX="$GIT_PROMPT_INFO"
ZSH_THEME_GIT_PROMPT_SUFFIX="$GIT_PROMPT_INFO%F{$gray9}] "
...
PROMPT="
$RESET_COLORS%F{$mediumcyan}%n@%m%F{$gray9}:$RESET_COLORS%F{$brightgreen}%~$RESET_COLORS "$'$(git_prompt_info)'"%F{$gray9}%%$RESET_COLORS "
