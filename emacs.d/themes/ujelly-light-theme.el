;;; ujelly-light-theme.el --- Ujelly theme for GNU Emacs 24 (deftheme)
...
(deftheme ujelly-light "The ujelly color theme")

(let ((class '((class color) (min-colors 89)))
      (ujelly-fg "#ffffff")
      (ujelly-bg (if (display-graphic-p) "#1a2328" nil))
      ...
      (custom-theme-set-faces
       ...
       `(highlight-indentation-face ((,class (:background ,ujelly-bg))))
       `(highlight-indentation-current-column-face ((,class (:background ,ujelly-bg))))
...
(provide-theme 'ujelly-light)

;;; ujelly-light-theme.el ends here
